...
class TextEditor:
    ...
    def __init__(self):
        ...
        self.photo = PhotoImage(file = "E:\\My Data Science full for job - Copy\\Project Practice for Placements\\Day-01\\Beginner-Python-Projects-main\\Text Editor\\edit-text.png")
